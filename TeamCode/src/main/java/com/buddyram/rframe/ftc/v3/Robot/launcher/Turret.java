...
public class Turret extends BaseComponent<Robot> {
    ...
    public static final int GEAR_TEETH = 60;
    public static final int PULLEY_TEETH = 15;
    public static final int ENCODER_TICKS_PER_REV = 28;
    public static final double TICKS_PER_DEGREE = -ENCODER_TICKS_PER_REV * GEAR_TEETH * 5 / (PULLEY_TEETH * 360.0);
