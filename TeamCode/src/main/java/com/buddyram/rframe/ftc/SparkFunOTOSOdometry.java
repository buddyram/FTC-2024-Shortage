...
//        this.sensor.setAngularScalar(3600.0 / 3623.0); // odometry reading after 10 rotations.
        ...
        this.sensor.setOffset(offset);
        this.sensor.setLinearScalar(68 / 71.05); // odometry reading after 68 inches forward
        this.sensor.setAngularScalar(3600 / 3600.8); // odometry reading after 10 rotations.
