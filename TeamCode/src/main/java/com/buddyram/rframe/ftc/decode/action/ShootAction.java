...
public class ShootAction implements RobotAction<DecodeBot> {
    public static final ConditionalWrapperAction<DecodeBot> WAIT_FOR_CORRECT_SPEED = new ConditionalWrapperAction<DecodeBot>(
            Flywheel.setRPMTo(3000), (drive) -> drive.getLauncher().wheel.isReady()
    );
